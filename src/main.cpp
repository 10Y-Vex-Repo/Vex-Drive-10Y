...
void skillsAuton() {
    ...
    chassis.moveToPoint(-7.5, 26.5, 2000, {.forwards = false});
    toptakes(-127, -70);
    intake.move(-100);
    pros::delay(5000);
    toptakes(0, 0);
    ...
    chassis.moveToPoint(-35, 1, 2000, {.maxSpeed = 100});
    matchLoader.extend();
    chassis.turnToHeading(-180, 1000);
    toptakes(-100, 0);
    intake.move(-127);
    chassis.moveToPoint(-35.5, -11, 1500, {.maxSpeed = 60});
    pros::delay(3000);
    intake.move(0);
    toptakes(0, 0);
    pros::delay(100);
    ...
    chassis.moveToPoint(-37.5, 68, 1500);
    chassis.turnToHeading(0, 1000);
    chassis.moveToPoint(-37.5, 60, 1500, {.forwards = false, .minSpeed = 100});
    intake.move(-127);
    toptakes(127, 114);
    pros::delay(3000);
    toptakes(0, 0);
    ...
    matchLoader.extend();
    chassis.moveToPoint(-35.5, 75, 1000, {.minSpeed = 80});
    toptakes(-100, 0);
    intake.move(-127);
    pros::delay(300);
    chassis.moveToPoint(-35.5, 84, 1000, {.maxSpeed = 60});
    pros::delay(3000);
    intake.move(0);
    toptakes(0, 0);
    // end of second matchloading

    chassis.moveToPoint(-36.5, 66, 1000, {.forwards = false, .minSpeed = 80});
    chassis.moveToPoint(-36.5, 59, 1000, {.forwards = false, .maxSpeed = 60});
    matchLoader.retract();
    ...
    chassis.turnToHeading(90, 1000);
    chassis.moveToPoint(35, 68, 4000);
    ...
    intake.move(-127);
    toptakes(-100, 0);
    chassis.moveToPoint(35.5, 84.5, 2000, {.maxSpeed = 60});
    pros::delay(3000);
    intake.move(0);
    toptakes(0, 0);
    ...
    chassis.turnToHeading(-90, 1000);
    chassis.moveToPoint(36, 5, 1500);
    chassis.turnToHeading(-180, 1000);
    chassis.moveToPoint(36, 11, 1500, {.forwards = false});
    intake.move(-127);
    toptakes(127, 114);
    pros::delay(3000);
    intake.move(0);
    ...
    matchLoader.extend();
    chassis.moveToPoint(35.5, -6, 1500, {.minSpeed = 80});
    intake.move(-127);
    toptakes(-100, 0);
    chassis.moveToPoint(35.5, -14.5, 1000, {.maxSpeed = 50});
    pros::delay(3000);
    intake.move(0);
    toptakes(0, 0);
    // end of 4th matchloading bottom right

    chassis.moveToPoint(35.5, 6, 1500, {.forwards = false, .minSpeed = 80});
    chassis.moveToPoint(35.5, 11, 1000, {.forwards = false, .maxSpeed = 50});
    intake.move(-127);
    toptakes(127, 114);
    pros::delay(3000);
    intake.move(0);
